...
class HpLib_ExtractorHpLibRendererBuilder implements HpLib_RendererBuilder {
    ...
    public void buildRenderers(VideoPlayerActivity player) {
        ...
        // Invoke the callback.
        TrackRenderer[] renderers = new TrackRenderer[VideoPlayerActivity.RENDERER_COUNT];
        renderers[VideoPlayerActivity.TYPE_VIDEO] = videoRenderer;
        renderers[VideoPlayerActivity.TYPE_AUDIO] = audioRenderer;
