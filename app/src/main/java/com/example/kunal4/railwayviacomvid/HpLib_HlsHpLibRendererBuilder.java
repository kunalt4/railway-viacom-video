...
class HpLib_HlsHpLibRendererBuilder implements HpLib_RendererBuilder {
    ...
    public HpLib_HlsHpLibRendererBuilder(VideoPlayerActivity player, String userAgent, String video_url) {
        this.context = player;
    ...
    @Override
    public void buildRenderers(VideoPlayerActivity player) {
    ...
    private static final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<HlsPlaylist> {
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url, VideoPlayerActivity player) {
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                    MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, VideoPlayerActivity.TYPE_VIDEO);
