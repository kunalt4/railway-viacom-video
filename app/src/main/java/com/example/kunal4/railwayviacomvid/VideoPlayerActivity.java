...
public class VideoPlayerActivity extends AppCompatActivity implements HlsSampleSource.EventListener, View.OnClickListener{
                ...
                public void run() {
                    switch (player.getPlaybackState()) {
                        ...
                        case ExoPlayer.STATE_READY:
                            loadingPanel.setVisibility(View.GONE);
//                            Long secs = TimeUnit.MILLISECONDS.toSeconds(player.getCurrentPosition()) -
